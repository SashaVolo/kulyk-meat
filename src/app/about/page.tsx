          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-700 leading-relaxed text-lg">
                М'ясна майстерня <b>Братів Куликів</b> — це не просто бізнес, це сімейна історія, що почалася з бажання їсти справжнє. Ми втомилися від "магазинних" делікатесів зі смаком хімії та вирішили створити продукт, який хочеться поставити на стіл для найрідніших.
              </p>
